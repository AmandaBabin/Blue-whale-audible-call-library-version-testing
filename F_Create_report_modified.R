...
deployment = "MGL_2019_10" # name of deployment to summarize
metadata = "deployment_summary.csv" # name of metadata csv file - do not change unless necessary for special case
Bm_audible = TRUE # set as true if blue whale audible detector was used, false if annotations were opportunistic
...
render_report = function(
  ...
  rmarkdown::render(here("RMarkdown_Report",
    "Baleen_whale_analysis_report_modified.Rmd"), 
      params = list(
    ...
    output_file = paste0(r"(E:\new versions\v4_reduced\)",
                         deployment,
                         r"(\Results\)", 
