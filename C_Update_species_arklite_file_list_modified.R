...
annotations <- read_csv(paste0(r"(E:\new versions\v4_reduced\)",deployment_code,"\\",r"(Results\)",annotation_csv))

species_detections <- read_csv(paste0(r"(E:\new versions\v4_reduced\)","\\",deployment_code,
...
write_csv(file_list, paste0(r"(E:\new versions\v4_reduced\)","\\",deployment_code,
