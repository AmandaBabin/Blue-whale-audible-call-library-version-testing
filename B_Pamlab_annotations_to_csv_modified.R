...
### EDIT THESE:
file_path <- r"(D:\CSE_2022_10\ST6767-6769.d6\annotations)" #copy file path to annotations folder within recording folder, paste inside r"( )"

deployment_code <- "CSE_2022_10" #input deployment code here STN_YYYY_MM

#data_source <- "MAR"  # MAR if from any DFO-MAR projects, otherwise code for the folder 
...
write_csv(annomerge, paste0(r"(E:\new versions\v4_reduced\)","\\",deployment_code,
