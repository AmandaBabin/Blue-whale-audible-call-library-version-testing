...
csv_data<-read_csv(paste0(r"(E:\new versions\v4_reduced\)",params$deployment,
...
detections <- read_csv(paste0(r"(E:\new versions\v4_reduced\)" ,params$deployment,r"(\Validation\Arklite_Inputs\)",paste0(params$deployment,'_MBDetections.csv')), show_col_types = FALSE)%>% 
